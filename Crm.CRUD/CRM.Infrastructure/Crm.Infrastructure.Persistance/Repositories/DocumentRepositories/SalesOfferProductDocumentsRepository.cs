...
{
    public class SalesOfferProductDocumentsRepository : GenericRepository<SalesOfferProductDocument>, ISalesOfferProductDocumentRepository
    {
        private readonly AppDbContext _context;
        public SalesOfferProductDocumentsRepository(AppDbContext context) : base(context)
        {
